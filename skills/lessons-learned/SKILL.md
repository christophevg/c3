...
Review everything you have done and learned in this session. Propose improvements to skills, agents, project-level `AGENTS.md`, global agent instructions, and/or propose the creation of any new skills/agents to better support you in the future.
